...
public class PacienteBuilder {
    ...
    public  PacienteBuilder comEndereco(String cep, String logradouro, int numero, String cidade, String uf){
        this.endereco = new Endereco(cep, logradouro, numero, cidade, uf);
        return this;
    }
    ...
    public PacienteBuilder comTipoSangue(String tipoSangue){
        dadosFisicos.setTipoSanguineo(tipoSangue);
        return this;
    }
